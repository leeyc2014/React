...
export default function FoodCard({ a, b, c, d, e, f }) {
    ...
    return (
        <div className="border-2 border-gray-200 flex flex-row p-5">
            ...
            <div className="flex flex-col justify-between">
                ...
                <div className="pl-5">
                    <div className="w-full h-10 bg-gray-600 cursor-pointer flex flex-row justify-center items-center gap-10 font-bold text-white" onClick={handleClick}>
                        {isActive &&
                            <>
